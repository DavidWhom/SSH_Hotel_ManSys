...
<script type="text/javascript">
	$(function(){
		...
		$("#getUser").click(function(){
			...
			var url = "order-getCheckOutRecord?id=" + id;
			...
			$.post(url,args,function(data){
				if(data != "0"){
					...
					if(backData.isRoomed != "0"){
						alert("用户 " + backData.name + " 账号无入住信息！");
						return false;
					}
									...
									<table class="table " ><!-- style="height: 300px" -->
										<tbody>
											<tr>
												...
												<td colspan="3">
													<input size="10" id="id" type="text" name="id" value="${id }"/>
									...
									<table class="table">
										<tbody>
											...
											<tr>
												...
												<td>￥
													<input type="text" id="price" name="price" size="5" value="${room.roomType.price }"/>
												</td>
											</tr>
											<tr>
											...
											<tr style="height: 10%;overflow: hidden;">
												<td><span class="label label-primary">离店时间</span></td>
												<td>
