				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline" style="height: 95%">
						<div class="panel-heading_user_edit">
							<h3 class="panel-title">会员信息添加</h3>
						</div>
						<hr>
						<div class="user-edit" style="padding-left: 20%">
						<form action="user-saveUser" enctype="multipart/form-data" method=post>
						...
						<tr class="for_showImg">
							...
							<td rowspan="3" class="img">
								<img id="preview1" src="img/styleImg/default.jpeg"/>
								&nbsp;&nbsp;
						...
						<tr>
							<td>
								<span class="label label-primary">性别</span>
									<input name="gender" value="男" type="radio" checked="checked">
									男
						...
						<tr class="for_showImg">
							...
							<td rowspan="3" class="img" >
								<img id = "preview2" src="img/headImg/default.jpg"/>
								&nbsp;&nbsp;
						...
						<tr>
							...
							<td>
								<span class="label label-primary">是否VIP</span>
									<input name="isVip" value="false" type="radio" checked="checked">
									普通
									<input name="isVip" value="true" type="radio">
									会员
							</td>
						</tr>
						<tr>
