...
<script type="text/javascript">
	$(function(){
		$("#pageNo").change(function(){
			...
			//3.页面跳转
			var href = "order-getRecords?pageNo=" + pageNo + "&" + $(":hidden").serialize();
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-headline">
								<form action="order-getRecords" method="post">
										<label>单号：</label>
								...
								<div class="panel-body">
									...
									<div class="row">
										<ul id="PageNum">
											...
											<li>
													<a href="order-getRecords?pageNo=1">首页</a>
											</li>
											<li>
												<s:if test="#orderPage.hasPrev">
													<a href="order-getRecords?pageNo=${orderPage.prevPage }">上一页</a>
												</s:if>
											</li>
											<c:forEach var="pageNum" begin="1" end = "${orderPage.totalPageNumber }"
												...
												<c:if test="${pageNum <= 6 }">
													<li>
														<a href="order-getRecords?pageNo=${pageNum }">${pageNum }</a>
													</li>
												</c:if>
											</c:forEach>
											<li>
												<s:if test="#orderPage.hasNext">
													<a href="order-getRecords?pageNo=${orderPage.nextPage }">下一页</a>
												</s:if>
											</li>
											<li>
												<a href="order-getRecords?pageNo=${orderPage.totalPageNumber }">末页</a>
											</li>
