					...
					<div class="panel panel-headline" style="height: 90%">
						...
						<tr class="for_showImg">
							...
							<td rowspan="3" class="img">
								<img id = "preview1"  src="img/adminImg/${model.imgPath }"/>
								&nbsp;&nbsp;
								<input type="file" class="btn btn-default" name="styleImg" id="styleImg">
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<span class="label label-primary">昵称</span>
								<input type="text" name="model.styleName" value="${model.styleName}">
							</td>
						</tr>
						<tr class="for_showImg">
							<td>
								<span class="label label-primary">密码</span>
								<input type="text" name="model.password" value="${model.password}">
							</td>
							<td>
								<span class="label label-primary">是否可用</span>
								<s:if test='#request.usable'>
									<input name="model.usable" value="1" type="radio" checked="checked">
									可用
									<input name="model.usable" value="0" type="radio">
									禁用
								</s:if>
								<s:else>
									<input name="model.usable" value="1" type="radio">
									可用
									<input name="model.usable" value="0" type="radio" checked="checked">
									禁用
								</s:else>
							</td>
						</tr>
